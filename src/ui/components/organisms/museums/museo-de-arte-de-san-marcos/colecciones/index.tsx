...
import { retratosSiglosXviXxi } from '@/ui/data/museums/retratos-siglos-xvi-xxi-data';
import { artePopularData } from '@/ui/data/museums/arte-popular-data';
import { arteModernoContemporaneoData } from '@/ui/data/museums/arte-moderno-contemporaneo-data';
import { archivoDibujoPinturaCampesinaData } from '@/ui/data/museums/archivo-dibujo-pintura-campesina-data';
					...
					<div className="lg:max-w-[394px]">
						...
						<div className="font-medium leading-[24px] mt-6">
							<p>
								...
								permite recorrer los diversos estilos de la
								pintura limeña. Tiene gran relevancia
								institucional e histórica pues está integrada
								por retratos de autoridades y personajes
								ilustres, entre ellos, hombres de letras,
								teólogos, científicos y matemáticos, muchos de
								los cuales fueron rectores y catedráticos de la
								Universidad. Cabe destacar dentro de esta
								colección, la presencia de grandes artistas como
								Bernardo Bitti (siglo XVI), Rafael Ortega, Ramón
								Muñiz, Teófilo Castillo (siglo XIX - XX), Felipe
								Cossio del Pomar (siglo XX) y Etna Velarde
					...
					<div className="lg:max-w-[394px]">
						...
						<div className="font-medium leading-[24px] mt-6">
							<p>
								...
								regiones del Perú. Destacan piezas de cerámica,
								retablos, imaginería, keros, mates, cuernos,
								textiles, cueros y piedras de Huamanga,
								realizadas a lo largo de todo el siglo XX, así
								como algunos ejemplares del siglo XVIII y XIX.
								La colección nace con piezas recopiladas por dos
								importantes personalidades, la artista Alicia
								Bustamante y el historiador Pablo Macera,
								quienes donaron parte de sus importantes
								colecciones al momento de la creación del MASM
								en 1970. Desde entonces, la colección ha ido
								incrementándose gracias al empeño e iniciativa
								de investigadores, coleccionistas y artistas que
								han realizado generosos donativos, que
								evidencian las transformaciones que se
								experimentan en el amplio campo del arte
								elaborado a lo largo del Perú.
							</p>
						</div>
					</div>
				</div>
					...
					<div className="lg:max-w-[394px]">
						...
						<div className="font-medium leading-[24px] mt-6">
							<p className="mb-6">
								...
								arte peruano contemporáneo, que configura un
								amplio panorama de las artes visuales en Perú,
								desde las primeras décadas del siglo XX hasta la
								actualidad. Presentes están importantes
								tendencias artísticas como el indigenismo, el
								surrealismo, la abstracción geométrica, el pop
								art, el op art, el realismo político social,
								entre otras.
							</p>
							<p>
								Parte de estas obras proceden de los Salones
								Nacionales de Artes Plásticas que la UNMSM
								organizó entre las décadas de 1950 y 1960.
								Además figuran piezas cedidas por los propios
								artistas gracias a gestión de distintos
								directores; como producto de las muestras
								individuales y salones de arte organizados entre
								las décadas de 1970 y 2000; así como otras
								actividades de carácter internacional como la
								Bienal Iberoamericana de Lima.
							</p>
						</div>
					</div>
					<div className="max-lg:w-full">
					...
					<div className="lg:max-w-[394px]">
						...
						<div className="font-medium leading-[24px] mt-6">
							<p>
								...
								cuatro mil obras provenientes del Concurso
								Nacional de Dibujo y Pintura Campesina,
								realizado entre 1984 y 1996, certámenes que
								congregaron una numerosa cantidad de
								participantes de diversas zonas rurales del
								país. Esta colección constituye un valioso
								documento gráfico y escrito sobre la historia
								rural contemporánea de nuestro país, contada por
								sus propios protagonistas cuyas memorias han
								sido realizadas con diversos materiales y
								técnicas. Los temas que abordan estos
								testimonios son variados: sucesos relacionados
								con la violencia política, la pobreza, la
								situación de las mujeres en el campo, los
								cambios que se vienen operando en el campo a
								raíz del intercambio con la ciudad y el fenómeno
								de la globalización, la marginación, los sueños
								y esperanzas en el futuro, entre otros.
							</p>
						</div>
					</div>
				</div>
