			...
			<div className="px-4 lg:px-[104px] bg-dark-white-2 pt-[24px] pb-[56px]">
				<div className="container flex flex-row justify-between gap-x-[68px]">
					<div className="max-w-[641px] leading-[24px] text-dark-blue-2">
						<p className="mb-5">
							La Escuela de Ballet San Marcos es un espacio de
							encuentro entre docentes y alumnos en el que se
							desarrollan estudios de danza desde los 03 años de
							edad en adelante. El avance de los alumnos es por
							niveles
						</p>
						<p className="mb-5">
							Si tienes pasión por la danza y deseas formar parte
							de esta gran familia, puedes ver todas nuestras
							convocatorias a través de nuestras redes sociales
							¡te esperamos!
						</p>
						...
						<p className="mb-5 font-bold">¿Qué ofrecemos?</p>
						<ul className="mb-5 list-disc list-outside pl-5">
							<li>
								Clases de ballet clásico y contemporáneo para
								todos los niveles.
							</li>
							<li>Un equipo docente altamente cualificado.</li>
							<li>
								Un ambiente de aprendizaje creativo y
								estimulante.
							</li>
							<li>
								La oportunidad de participar en presentaciones y
								proyectos especiales.
							</li>
						</ul>
						<p>
							¡No te pierdas esta oportunidad de crecer como
							bailarín y de contribuir al desarrollo de la danza
							en el Perú!
						</p>
					</div>
