			...
			<div className="px-4 lg:px-[104px] bg-dark-white-2 pt-[24px] pb-[56px]">
				<div className="container">
					<p className="max-w-[641px] leading-[24px] text-dark-blue-2">
						Cada publicación es una ventana abierta a la diversidad
						y profundidad de nuestras raíces, presentando
						investigaciones y relatos que honran la herencia
					...
					<div className="relative pt-[56px] lg:pt-[96px] pb-[56px] lg:pr-16 lg:semi-container-l h-full">
						<header className="max-w-[459px] text-white">
							...
							<p className="max-md:text-sm mt-6 font-medium leading-[24px]">
								...
								vacíos en la investigación de las
								manifestaciones folklóricas del Perú y
								consolidarse como referente en el ámbito
								académico.
							</p>
						</header>
						<SecondaryButton
					...
					<div className="relative pt-[56px] lg:pt-[96px] pb-[56px] lg:pl-16 lg:semi-container-r h-full">
						<header className="max-w-[459px] text-white">
							...
							<p className="max-md:text-sm mt-6 font-medium leading-[24px]">
								...
								páginas, de fácil lectura, relacionados a temas
								de folklore y educación; estos son escritos por
								investigadores, estudiantes de la cultura y
								estudiantes de nuestra Escuela de Capacitación
								en Folklore.
							</p>
						</header>
						<SecondaryButton
