...
import { elencoInfantilData } from '@/ui/data/direcciones/elenco-infantil-data';
			...
			<div className="container flex flex-col gap-y-8 lg:grid lg:grid-cols-[minmax(0,1fr)_auto] items-start justify-between gap-x-8 relative">
				<div className="max-w-[394px] order-2">
					<h3 className="text-[32px] leading-[normal] font-semibold">
						Elenco Infantil de Danzas de la Universidad Nacional
						Mayor de San Marcos
					</h3>
					<div className="font-medium leading-[24px] mt-6">
						<p className="mb-5">
							El Elenco Infantil de la UNMSM fue creado en 1999 y
							está formado por niños y niñas entre los 7 y 12 años
							de edad, integrantes con muchas ganas de aprender,
							conocer y difundir nuestra cultura y tradición.
						</p>
						<p className="mb-5">
							En el Elenco Infantil, los niños sociabilizan,
							comparten, disfrutan y crecen artísticamente,
							además, con ayuda de la danza, desarrollan su
							inteligencia corporal y habilidades como
							coordinación, balance, destreza, fuerza,
							flexibilidad, velocidad y la capacidad de unir el
							cuerpo y la mente para una ejecución física óptima.
						</p>
						<p>
							Su formación artística va de la mano con su
							desarrollo integral, por lo tanto, tenemos como
							resultado un elenco competitivo, cohesionado y con
							valores que les sirven para asumir nuevos y grandes
							retos.
						</p>
					</div>
				</div>
