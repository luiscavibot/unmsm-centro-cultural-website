...
import { galeriaDeImagenesData } from '@/ui/mocks/nosotros/historia/galeria-de-imagenes-data';
			...
			<div className="container flex flex-col gap-y-8 lg:grid lg:grid-cols-[auto_minmax(0,1fr)] items-start justify-between gap-x-8 relative">
				<div className="max-w-[394px]">
					...
					<p className="font-medium leading-[24px] mt-6">
						Sumérgete en el pasado y presente de uno de los
						monumentos más emblemáticos de Lima a través de esta
						galería de imágenes.
					</p>
				</div>
