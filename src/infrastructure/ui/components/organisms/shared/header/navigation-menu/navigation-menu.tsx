		...
		>
			{
				href ? (
					<>
						{
							external ? (
								<a href={href} rel="noopener noreferrer" target="_blank" className="text-sm relative h-[49px] inline-flex items-center leading-[16.8px] p-4 text-white">
									{children}
									<span
										style={{
								...
								:
								(
									<Link href={href} className="text-sm relative h-[49px] inline-flex items-center leading-[16.8px] p-4 text-white">
										{children}
										<span
											style={{
												transform: showFlyout ? "scaleX(1)" : "scaleX(0)",
					...
					:
					(
						<div className="text-sm relative h-[49px] inline-flex items-center leading-[16.8px] p-4 text-white cursor-default">
							{children}
							<span
								style={{
									transform: showFlyout ? "scaleX(1)" : "scaleX(0)",
			...
			<AnimatePresence>
				{showFlyout && (
					<motion.div
						...
						className="absolute left-1/2 top-[51px] bg-dark-gray"
					>
...
const ArtisticDirectionsContent: FC = () => {
	return (
		<div className="w-[204px] text-white py-2 shadow-xl">
			<Link href="#" className="flex imtes-center p-4 h-[48px] leading-[16.8px] text-sm hover:bg-gray transition-colors duration-300">
				Ballet
			</Link>
			<Link href="#" className="flex imtes-center p-4 h-[48px] leading-[16.8px] text-sm hover:bg-gray transition-colors duration-300">
				Folklore
