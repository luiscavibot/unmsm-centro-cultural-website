		...
		<>
			<div className="px-4 lg:px-[104px] bg-dark-white-2 pt-[24px] pb-[56px]">
				<div className="container">
					<p className="max-w-[641px] leading-[24px] text-dark-blue-2">Nuestras exposiciones permanentes y temporales te invitan a recorrer el tiempo y el espacio, descubriendo historias fascinantes que nos conectan con el pasado, el presente y el futuro. Cada sala de nuestro museo guarda tesoros únicos, desde obras maestras de grandes artistas.</p>
				</div>
			</div>
