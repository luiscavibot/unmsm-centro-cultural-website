...
const Contact: React.FC = () => {
	return (
		<>
			<div className="px-[104px] gap-5 bg-green text-white py-[45px] bg-[url('https://unmsm-static-files-v2.s3.us-east-2.amazonaws.com/centro-cultural-de-san-marcos/bg-contactanos.svg')] bg-no-repeat bg-[-47px}_-100px]">
