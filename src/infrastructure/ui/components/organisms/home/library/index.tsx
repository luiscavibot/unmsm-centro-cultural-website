			...
			<div className="relative px-6 lg:px-[104px] pt-[56px] lg:pt-[96px] pb-[56px] h-[360px] lg:h-[720px] group">
				...
				<div className="container h-full flex items-center justify-center">
					<div className="max-w-[606px] text-center text-white">
						<h2 className="text-[24px] lg:text-[32px] font-bold leading-[normal]">Biblioteca España de las Artes</h2>
						<p className="text-sm lg:text-base mt-2 leading-[21px] lg:leading-[24px]">Contamos con una gran variedad de recursos bibliográficos en diferentes formatos y disciplinas; siendo también un espacio de recreación y fomento de actividades culturales.</p>
						<SecondaryButton type="internal-link" href="#" theme="dark" label="Explorar" className="mt-6 lg:mt-8" />
					</div>
				</div>
			</div>
		</section>
