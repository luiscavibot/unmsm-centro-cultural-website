		...
		<section id="biblioteca" className="scroll-mt-28">
			<div className="relative px-[104px] pt-[96px] pb-[56px] h-[720px] group">
				<figure className="absolute top-0 left-0 w-full h-full -z-10 overflow-hidden">
					<Image src="https://unmsm-static-files-v2.s3.us-east-2.amazonaws.com/centro-cultural-de-san-marcos/library-home.webp" className="object-cover transform group-hover:scale-110 transition-transform duration-1000" alt="events" fill />
				</figure>
