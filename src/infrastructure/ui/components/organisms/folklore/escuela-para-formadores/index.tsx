					...
					<div className="container">
						<div className="relative pt-[56px] lg:pt-[96px] pb-[96px] lg:pr-16 lg:w-[705px] mr-auto h-full text-white flex flex-row gap-6 leading-[24px] font-medium">
							<div className="basis-1/2">
								<p className="font-bold">¡Sé un profesional en la enseñanza de nuestras danzas!</p>
								<p className="mb-5">
									Participa del Programa de Capacitación y Actualización por Módulos y certifícate como &ldquo;Promotor en danzas Folklóricas&rdquo;.
								</p>
								<p className="font-bold">Sobre el programa</p>
