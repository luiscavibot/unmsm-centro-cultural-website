...
const ArrowButton: React.FC<ArrowButtonProps> = ({ onClick, direction, disabled = false, theme = 'dark' }) => {
	...
	const buttonClasses = `group w-10 h-10 rounded grid place-items-center transition-colors duration-200 ${themeClasses[theme]}`;
