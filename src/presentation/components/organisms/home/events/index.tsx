...
const Events: React.FC = () => {
	...
	const getPercentage = () => {
		if (elementWrapperRef.current && elementContainerRef.current) {
			...
			const elementWrapperRefCS = window.getComputedStyle(elementWrapperRef.current)
			const elementContainerRefCS = window.getComputedStyle(elementContainerRef.current)

			const newSum = parseFloat(elementWrapperRefCS.paddingLeft) + parseFloat(elementContainerRefCS.marginLeft);
