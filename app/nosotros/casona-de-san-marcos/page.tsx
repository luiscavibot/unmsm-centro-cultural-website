	...
	return (
		...
		>
			<>
				...
				<div className="px-4 lg:px-[104px] bg-dark-red-2 text-white py-[104px] overflow-hidden">
					<div className="container">
						<h2 className="hidden sr-only">Historia</h2>
						<div className="max-w-[814px] mx-auto">
							<div>
								<div className="flex flex-col lg:flex-row gap-x-8 gap-y-8">
									<h3 className="text-2xl font-bold leading-[36px] lg:w-[220px] flex-shrink-0 max-lg:text-center">
										Siglos XVII - XVIII
									</h3>
				...
				<div className="px-4 lg:px-[104px] bg-white py-8 lg:pt-[80px] lg:pb-[104px] pb-20">
					<div className="container grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 sm:grid-rows-[821px_403px_403px_821px_402px_402px_821px_905px]">
