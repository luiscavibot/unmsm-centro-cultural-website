			...
			<div className="px-4 lg:px-[104px] bg-white pb-[104px]">
				<div className="container">
					<div className="max-w-[814px] mx-auto mb-[80px]">
						...
						<Title className="text-center !mb-2">“Protegiendo nuestros textiles milenarios”: Conservación preventiva para textiles arqueológicos</Title>
						<div className="flex flex-row items-center justify-center gap-2 mb-14">
							<div className="p-4 text-green bg-light-green rounded-lg">
								<span className="font-bold">Inicio:</span> 5 de noviembre de 2024
							</div>
						</div>
						<div className="flex gap-x-1 justify-center mb-14">
							<div className="min-w-[235px]">
								<div className="flex gap-1 items-center">
									<ClassIcon className="shrink-0" ariaLabel="Clases" color="dark" />
									<span className="leading-[24px] font-bold">Clases</span>
								</div>
								<p className="pl-5 font-medium leading-[21px] text-sm">
									Martes y jueves
									(5, 7, 12 de noviembre de 2024)
								</p>
							</div>
							...
							<div className="min-w-[215px]">
								<div className="flex gap-1 items-center">
									...
									<span className="leading-[24px] font-bold">Cierre de inscripciones</span>
								</div>
						...
						<div className="space-y-4">
							<p>El Museo de Arqueología y Antropología de la UNMSM presenta el taller especializado «Protegiendo Nuestros Textiles Milenarios», una iniciativa destinada a la <b>conservación preventiva de textiles arqueológicos</b>. Este taller brindará a los participantes herramientas y conocimientos para la <b>realización de un registro adecuado</b>, la creación de <b>cajas contenedoras</b> y el diseño de <b>soportes protectores</b> para preservar estos valiosos bienes culturales.</p>
							<p>Los participantes aprenderán a manejar técnicas esenciales para garantizar la protección y conservación de textiles arqueológicos, salvaguardando así piezas de incalculable valor histórico y cultural.</p>
						</div>
					</div>
				</div>
			</div>
